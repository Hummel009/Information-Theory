...
Для запуска и редактирования каждого проекта потребуется среда разработки Kotlin и JDK. Подойдёт ***IntelliJ IDEA*** или ***Eclipse IDE + Kotlin Plugin***, а также ***JDK 1.8.0_382***. Чтобы приступить к работе, необходимо импортировать папку как Gradle-проект.
